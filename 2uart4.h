...
#define PID_ROW_START    0      // 第一个PID行
#define ROW_HEIGHT      8       // 每行高度8像素（备用）
#define MAX_PID_DISPLAY 6       // 最多显示6个PID
#define PID_COL         0       // "PID=" 起始列
#define STATUS_COL      32      // 状态起始列
#define TX_LIST_COL     72      // 异常TX列表起始列（备用）
#define MAX_TX_COUNT    TOTAL_SLAVES      // 根据实际设备数量调整
#define STATUS_STR_LEN  16      // 状态字符串最大长度
